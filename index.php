    ...
    <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
      <div class="container">
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
          <img src="img/jay.jpeg" class="img-fluid" width="300" />
          <div>
...
<!-- article end -->
        ...
        <div id="carouselExample" class="carousel slide">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="img/auditorium.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
              <img src="img/perpustakaan.jpg" class="d-block w-100" alt="..." />
            </div>
            <div class="carousel-item">
    ...
    <section id="aboutme" class="text-center p-5 bg-danger-subtle">
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          <div class="p-3">
            <img
              src="img/Logo_udinus1.jpg"
              class="rounded-circle border shadow"
              width="300"
            />
          </div>
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.14953</h3>
            <h1 class="fw-bold">Dwi Jayeng Kusumo</h1>
    ...
    <footer id="footer" class="text-center p-5">
      ...
      <div>Dwi Jayeng Kusumo &copy; 2023</div>
    </footer>
    <!-- footer end -->
